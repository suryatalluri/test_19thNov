 ...
 * @see com.test_19thnov.test_20thnov.Table2
 */
@Service("Test_20thNov.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("Test_20thNov.Table2Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "Test_20thNovTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "Test_20thNovTransactionManager")
    @Override
