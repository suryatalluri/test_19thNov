...
import com.test_19thnov.testproc.service.EmployeeService;
...
import com.test_19thnov.testproc.*;
import com.test_19thnov.testproc.service.*;


/**
 * Controller object for domain model class Employee.
 * @see com.test_19thnov.testproc.Employee
 */

@RestController(value = "Testproc.EmployeeController")
@Api(value = "/Testproc/Employee", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/Testproc/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

	@Autowired
	@Qualifier("Testproc.EmployeeService")
