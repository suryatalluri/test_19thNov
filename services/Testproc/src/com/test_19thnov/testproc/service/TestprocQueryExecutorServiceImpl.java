...
@Service
public class TestprocQueryExecutorServiceImpl implements TestprocQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestprocQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("TestprocWMQueryExecutor")
